...
function setApi() {
  ...
  if (currentDate.getMonth() < 10 || currentDate.getDate < 10) {
    ...
    if (currentDate.getMonth() < 10 && currentDate.getDate() < 10 ) {
      ...
      return sourceLink+currentDate.getFullYear() + '/' + month+'-'+day+'_'+'DK1'+'.json'
    }else if (currentDate.getMonth() < 10 && currentDate.getDate() >= 10) {
      let month =  '0' + (currentDate.getMonth()+1)
      return sourceLink+currentDate.getFullYear() + '/' + month+'-'+currentDate.getDate()+'_'+'DK1'+'.json'
    } else {
        let day = '0' + (currentDate.getDate())
        return sourceLink+currentDate.getFullYear() + '/' + currentDate.month+'-'+day+'_'+'DK1'+'.json'
    }
  }
  return sourceLink+currentDate.getFullYear() + '/' + currentDate.getMonth()+'-'+currentDate.getDate()+'_'+'DK1'+'.json'
}
